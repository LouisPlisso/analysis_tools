...
def latex_dir(outfile_name, directory, column=2):
...
def main():
    ...
    for directory in args:
        ...
        if options.column not in (1, 2):
            ...
            parser.print_help()
            exit(5)
        latex_dir(outfile_name, directory, options.column)
